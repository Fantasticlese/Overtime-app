...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a scope so that only post creators can see their posts' do
      ...
      other_user = User.create(first_name: "Non", last_name: "Authorized", email: "nonauth@test.com", password: "password", password_confirmation: "password")
  ...
  describe 'edit' do
    before do
      @edit_user = User.create(first_name: "asdf", last_name: "asdf", email: "asdfasdf@asdf.com", password: "password", password_confirmation: "password")
